...
class Geol_Redirects {
	...
	public function add_shortcode( $atts, $content = '' ) {
		...
		if ( isset( $post->ID ) ) {
			return self::get_geo_link_from_id( $post->ID, $atts, $content );
		}
	 ...
	 * @return string|void
	 */
	public static function get_geo_link_from_id( $post_id , $atts, $content = "") {
		...
		// return final link when cloaking deactivated
		if( 'no' == apply_filters('geolinks/disable_cloak_in_shortcodes', $atts['cloak'] ) ) {
			$url = '';
